...
enum gapc_operation
{
    ...
    GAPC_OP_DEPRECATED_0,//d
    GAPC_OP_DEPRECATED_1,//e
    GAPC_OP_DEPRECATED_2,//f
    GAPC_OP_DEPRECATED_3,//10
    GAPC_OP_DEPRECATED_4,//11

    /* LE Ping*/
    /// get timer timeout value
    GAPC_GET_LE_PING_TO,//12
    /// set timer timeout value
    GAPC_SET_LE_PING_TO,//13

    /* LE Data Length extension*/
    /// LE Set Data Length
    GAPC_SET_LE_PKT_SIZE,//14

    /* Central Address resolution supported*/
    GAPC_GET_ADDR_RESOL_SUPP,//15

    /* Secure Connections */
    /// Request to inform the remote device when keys have been entered or erased
    GAPC_KEY_PRESS_NOTIFICATION,//16
...
struct p_gapc_state{
	const char* gapc_state_str;
};

extern struct p_gapc_state gapc_state_ins[GAPC_OPSTATE_MAX];
