...
#include "user_config.h"
	...
	#define UART_CLI_PRINTF uart_printf_null
	#define KT_PRINTF uart_printf
	#ifdef STACK_UART_CLASS_DETAIL
		#define UART_PRINTF_CLASS_DETAIL
	#endif
	#endif //!BLE_TESTER
...
typedef  int (*uart_callback)(const char *fmt,...);
